    ...
    public void EnsureOperationAllowed(Operation op)
    {
        if (_options.ReadOnly)
        {
            throw new McpException(
                ...
                $"(RemoteAdmin:ReadOnly=true in RemoteAdminMCPSharp.json). All mutating tools — including '{op}' — " +
        ...
        if (!_options.Operations.IsEnabled(op))
        {
            throw new McpException(
                ...
                $"RemoteAdmin:Operations:{op} is set to false in RemoteAdminMCPSharp.json (this is the default). " +
    ...
    public void EnsureArbitraryAllowed()
    {
        if (!_options.AllowArbitraryCommands)
        {
            throw new McpException(
                ...
                "RemoteAdmin:AllowArbitraryCommands=false in RemoteAdminMCPSharp.json (this is the default). " +
