...
RemoteAdminMCPSharp is licensed under the MIT License (see `LICENSE`). It
...
"PowerShell", "Windows", and "Microsoft" are trademarks of Microsoft
Corporation. Use of these names in this project does not imply endorsement by,
or affiliation with, Microsoft.
